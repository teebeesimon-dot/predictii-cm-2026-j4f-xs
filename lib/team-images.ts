...
club(65, 'Manchester City FC', 'Manchester City', 'Man City')
club(66, 'Manchester United FC', 'Manchester United', 'Man United')
...
club(10, 'VfB Stuttgart', 'Stuttgart')
club(100, 'AS Roma', 'Roma')
club(546, 'Racing Club de Lens', 'RC Lens', 'Lens')
club(610, 'Galatasaray SK', 'Galatasaray')
club(613, 'Fenerbahçe SK', 'Fenerbahce', 'Fenerbahçe')
club(7509, 'ŠK Slovan Bratislava', 'Slovan Bratislava', 'SK Slovan Bratislava', 'Sl. Bratislava')
club(851, 'Club Brugge KV', 'Club Brugge')
club(930, 'SK Slavia Praha', 'Slavia Praha', 'Slavia Prague')
club(1887, 'FK Shakhtar Donetsk', 'Shakhtar Donetsk', 'Shaktar Donetsk', 'Shaktar')
club(5720, 'Viking FK', 'Viking')
club(5721, 'FK Bodø/Glimt', 'Bodø/Glimt', 'Bodo/Glimt')
club(7397, 'Como 1907', 'Como')
club(10233, 'Sabah FK', 'Sabah')
